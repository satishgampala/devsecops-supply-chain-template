...
- workflow, fixture, script, image, and active-documentation values; and
...
Use `docs/operations/release-runbook.md` only after the initialized policies, repository rules, and hosted default-branch workflows have been observed.
